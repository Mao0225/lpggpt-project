...
public abstract class BaseAutoGasFillingWaitRecordHis<M extends BaseAutoGasFillingWaitRecordHis<M>> extends Model<M> implements IBean {
	...
	public void setHisCode(java.lang.String hisCode) {
		set("his_code", hisCode);
	}
	
	public java.lang.String getHisCode() {
		return getStr("his_code");
	}
	
	public void setHisReason(java.lang.String hisReason) {
		set("his_reason", hisReason);
	}
	
	public java.lang.String getHisReason() {
		return getStr("his_reason");
	}
	
	public void setHisTime(java.util.Date hisTime) {
		set("his_time", hisTime);
	}
	
	public java.util.Date getHisTime() {
		return getDate("his_time");
	}
