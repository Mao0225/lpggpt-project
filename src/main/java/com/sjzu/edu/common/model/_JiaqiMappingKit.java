...
public class _JiaqiMappingKit {
	...
	public static void mapping(ActiveRecordPlugin arp) {
		...
		// Composite Primary Key order: id,status
		arp.addMapping("dianzicheng", "id,status", Dianzicheng.class);
		...
		//arp.addMapping("t_iot_sync_records", "id", IotSyncRecords.class);，这个重复了，不用了，lpg数据源里有了
