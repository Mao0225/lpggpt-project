...
public class JiaqizhongController extends Controller {
    JiaqizhongService service = new JiaqizhongService();
    ...
    public void jiaqilist() {
        ...
        // 调用 Service 层的分页查询方法
        Page<AutoGasFillingWaitRecord> recordPage = service.paginate(pageNumber, pageSize,license_plate, gun_no);
        // 将查询结果传递到前端页面
