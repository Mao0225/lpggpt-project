...
public class OorderInfoService {
    BasBill dao = new BasBill().dao();
    public Page<BasBill> paginate(int pageNumber, int pageSize, String time, String station, String restaurantId,Integer companyId) {
        // 基础SQL
